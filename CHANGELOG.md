...
* [#ghsa-4jmp-x7mh-rgmr](https://github.com/babylonlabs-io/finality-provider-ghsa-4jmp-x7mh-rgmr) fix: eots pk sk verification

## v1.0.3

### Bug Fixes

* [#752](https://github.com/babylonlabs-io/finality-provider/pull/752) fix: max retries in the batch
