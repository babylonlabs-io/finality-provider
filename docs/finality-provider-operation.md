...
|--------|----------|----------------------------------------------|---------------|
| **Functions** | • Identifier of a finality provider<br>• Initial registration<br>• Signs finality votes and Schnorr signatures<br>• Generates randomness<br> | • Identifier of a finality provider<br>• Initial registration<br>• Withdrawing accumulated rewards<br>• Setting withdrawal addresses | • Daily operational transactions |
...
| **Key Relationships** | • Permanently paired with Babylon Genesis Key during registration| • Permanently paired with EOTS Key during registration<br>• Can delegate operations to Operation Key | • Not associated with the other keys |
