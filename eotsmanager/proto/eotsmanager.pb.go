...
type SignEOTSBothRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// uid is the identifier of an EOTS key, i.e., public key following BIP-340 spec
	Uid []byte `protobuf:"bytes,1,opt,name=uid,proto3" json:"uid,omitempty"`
	// chain_id is the identifier of the consumer chain that the randomness is committed to
...
func (x *SignEOTSBothRequest) Reset() {
	*x = SignEOTSBothRequest{}
	mi := &file_eotsmanager_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SignEOTSBothRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignEOTSBothRequest) ProtoMessage() {}

func (x *SignEOTSBothRequest) ProtoReflect() protoreflect.Message {
	mi := &file_eotsmanager_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignEOTSBothRequest.ProtoReflect.Descriptor instead.
func (*SignEOTSBothRequest) Descriptor() ([]byte, []int) {
	return file_eotsmanager_proto_rawDescGZIP(), []int{8}
}

func (x *SignEOTSBothRequest) GetUid() []byte {
	if x != nil {
		return x.Uid
	}
	return nil
...
func (x *SignEOTSBothRequest) GetChainId() []byte {
	if x != nil {
		return x.ChainId
	}
	return nil
...
func (x *SignEOTSBothRequest) GetMsg() []byte {
	if x != nil {
		return x.Msg
	}
	return nil
...
func (x *SignEOTSBothRequest) GetHeight() uint64 {
	if x != nil {
		return x.Height
	}
	return 0
...
type SignEOTSBothResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// sig is the EOTS signature
	Sig []byte `protobuf:"bytes,1,opt,name=sig,proto3" json:"sig,omitempty"`
	// pub_rand is the EOTS public randomness
	PubRand []byte `protobuf:"bytes,2,opt,name=pub_rand,json=pubRand,proto3" json:"pub_rand,omitempty"`
	// sig_unsafe is the EOTS signature signed using pub_rand_unsafe
	SigUnsafe []byte `protobuf:"bytes,3,opt,name=sig_unsafe,json=sigUnsafe,proto3" json:"sig_unsafe,omitempty"`
	// pub_rand_unsafe is the EOTS public randomness generated
	// by unsafe rand generator
	PubRandUnsafe []byte `protobuf:"bytes,4,opt,name=pub_rand_unsafe,json=pubRandUnsafe,proto3" json:"pub_rand_unsafe,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SignEOTSBothResponse) Reset() {
	*x = SignEOTSBothResponse{}
	mi := &file_eotsmanager_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SignEOTSBothResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignEOTSBothResponse) ProtoMessage() {}

func (x *SignEOTSBothResponse) ProtoReflect() protoreflect.Message {
	mi := &file_eotsmanager_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignEOTSBothResponse.ProtoReflect.Descriptor instead.
func (*SignEOTSBothResponse) Descriptor() ([]byte, []int) {
	return file_eotsmanager_proto_rawDescGZIP(), []int{9}
}

func (x *SignEOTSBothResponse) GetSig() []byte {
	if x != nil {
		return x.Sig
	}
	return nil
...
func (x *SignEOTSBothResponse) GetPubRand() []byte {
	if x != nil {
		return x.PubRand
	}
	return nil
...
func (x *SignEOTSBothResponse) GetSigUnsafe() []byte {
	if x != nil {
		return x.SigUnsafe
	}
	return nil
...
func (x *SignEOTSBothResponse) GetPubRandUnsafe() []byte {
	if x != nil {
		return x.PubRandUnsafe
	}
	return nil
}
...
var file_eotsmanager_proto_rawDesc = string([]byte{
	...
	0x52, 0x0b, 0x70, 0x75, 0x62, 0x52, 0x61, 0x6e, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x68, 0x0a,
	0x0f, 0x53, 0x69, 0x67, 0x6e, 0x45, 0x4f, 0x54, 0x53, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x10, 0x0a,
	...
	0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x24, 0x0a, 0x10, 0x53, 0x69, 0x67, 0x6e, 0x45,
	0x4f, 0x54, 0x53, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x73,
	0x69, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x73, 0x69, 0x67, 0x22, 0x6c, 0x0a,
	0x13, 0x53, 0x69, 0x67, 0x6e, 0x45, 0x4f, 0x54, 0x53, 0x42, 0x6f, 0x74, 0x68, 0x52, 0x65, 0x71,
	...
	,
	...
	,
	...
	,
	...
	,
})

var (
	file_eotsmanager_proto_rawDescOnce sync.Once
	file_eotsmanager_proto_rawDescData []byte
)

func file_eotsmanager_proto_rawDescGZIP() []byte {
	file_eotsmanager_proto_rawDescOnce.Do(func() {
		file_eotsmanager_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_eotsmanager_proto_rawDesc), len(file_eotsmanager_proto_rawDesc)))
	})
	return file_eotsmanager_proto_rawDescData
}

var file_eotsmanager_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_eotsmanager_proto_goTypes = []any{
	...
	(*SignEOTSBothRequest)(nil),              // 8: proto.SignEOTSBothRequest
	(*SignEOTSBothResponse)(nil),             // 9: proto.SignEOTSBothResponse
...
var file_eotsmanager_proto_depIdxs = []int32{
	...
	8,  // 3: proto.EOTSManager.SignEOTSBoth:input_type -> proto.SignEOTSBothRequest
	6,  // 4: proto.EOTSManager.UnsafeSignEOTS:input_type -> proto.SignEOTSRequest
	10, // 5: proto.EOTSManager.SignSchnorrSig:input_type -> proto.SignSchnorrSigRequest
	12, // 6: proto.EOTSManager.SaveEOTSKeyName:input_type -> proto.SaveEOTSKeyNameRequest
	...
	7,  // 9: proto.EOTSManager.SignEOTS:output_type -> proto.SignEOTSResponse
	9,  // 10: proto.EOTSManager.SignEOTSBoth:output_type -> proto.SignEOTSBothResponse
	7,  // 11: proto.EOTSManager.UnsafeSignEOTS:output_type -> proto.SignEOTSResponse
	11, // 12: proto.EOTSManager.SignSchnorrSig:output_type -> proto.SignSchnorrSigResponse
	13, // 13: proto.EOTSManager.SaveEOTSKeyName:output_type -> proto.SaveEOTSKeyNameResponse
...
func file_eotsmanager_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_eotsmanager_proto_rawDesc), len(file_eotsmanager_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   1,
