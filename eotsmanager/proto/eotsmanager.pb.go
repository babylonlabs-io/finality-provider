...
type SignEOTSBothResponse struct {
	...
	SigLegacy []byte `protobuf:"bytes,3,opt,name=sig_legacy,json=sigLegacy,proto3" json:"sig_legacy,omitempty"`
	// pub_rand_legacy is the EOTS public randomness generated
	// by legacy rand generator
	PubRandLegacy []byte `protobuf:"bytes,4,opt,name=pub_rand_legacy,json=pubRandLegacy,proto3" json:"pub_rand_legacy,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SignEOTSBothResponse) GetSigLegacy() []byte {
	if x != nil {
		return x.SigLegacy
	}
	return nil
...
func (x *SignEOTSBothResponse) GetPubRandLegacy() []byte {
	if x != nil {
		return x.PubRandLegacy
	}
	return nil
}
...
var file_eotsmanager_proto_rawDesc = string([]byte{
	...
	0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x69, 0x67, 0x5f, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x69, 0x67, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79,
	0x12, 0x26, 0x0a, 0x0f, 0x70, 0x75, 0x62, 0x5f, 0x72, 0x61, 0x6e, 0x64, 0x5f, 0x6c, 0x65, 0x67,
	0x61, 0x63, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x70, 0x75, 0x62, 0x52, 0x61,
	0x6e, 0x64, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x22, 0x3b, 0x0a, 0x15, 0x53, 0x69, 0x67, 0x6e,
