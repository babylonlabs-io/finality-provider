...
func (m *MockClientController) EditFinalityProvider(ctx context.Context, req *api.EditFinalityProviderRequest) (*types.MsgEditFinalityProvider, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientControllerMockRecorder) EditFinalityProvider(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditFinalityProvider", reflect.TypeOf((*MockClientController)(nil).EditFinalityProvider), ctx, req)
}
...
func (m *MockClientController) QueryFinalityProvider(ctx context.Context, fpPk *btcec.PublicKey) (*types.QueryFinalityProviderResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientControllerMockRecorder) QueryFinalityProvider(ctx, fpPk any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryFinalityProvider", reflect.TypeOf((*MockClientController)(nil).QueryFinalityProvider), ctx, fpPk)
}

// RegisterFinalityProvider mocks base method.
func (m *MockClientController) RegisterFinalityProvider(ctx context.Context, req *api.RegisterFinalityProviderRequest) (*types0.TxResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientControllerMockRecorder) RegisterFinalityProvider(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RegisterFinalityProvider", reflect.TypeOf((*MockClientController)(nil).RegisterFinalityProvider), ctx, req)
}
