...
//
//	mockgen -source=clientcontroller/api/interface.go -package mocks -destination /Users/gusin/Github/labs/cursor-local-deployment-repos/babylon-bsn-integration-deployment/finality-provider/testutil/mocks/clientcontroller.go
//
