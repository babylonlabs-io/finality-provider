...
// QueryPublicRandCommitList mocks base method.
func (m *MockConsumerController) QueryPublicRandCommitList(ctx context.Context, fpPk *btcec.PublicKey, startHeight uint64) ([]types0.PubRandCommit, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryPublicRandCommitList", ctx, fpPk, startHeight)
	ret0, _ := ret[0].([]types0.PubRandCommit)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// QueryPublicRandCommitList indicates an expected call of QueryPublicRandCommitList.
func (mr *MockConsumerControllerMockRecorder) QueryPublicRandCommitList(ctx, fpPk, startHeight any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryPublicRandCommitList", reflect.TypeOf((*MockConsumerController)(nil).QueryPublicRandCommitList), ctx, fpPk, startHeight)
}
...
// QueryPublicRandCommitList mocks base method.
func (m *MockRandomnessCommitter) QueryPublicRandCommitList(ctx context.Context, fpPk *btcec.PublicKey, startHeight uint64) ([]types0.PubRandCommit, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryPublicRandCommitList", ctx, fpPk, startHeight)
	ret0, _ := ret[0].([]types0.PubRandCommit)
	ret1, _ := ret[1].(error)
...
// QueryPublicRandCommitList indicates an expected call of QueryPublicRandCommitList.
func (mr *MockRandomnessCommitterMockRecorder) QueryPublicRandCommitList(ctx, fpPk, startHeight any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryPublicRandCommitList", reflect.TypeOf((*MockRandomnessCommitter)(nil).QueryPublicRandCommitList), ctx, fpPk, startHeight)
}
